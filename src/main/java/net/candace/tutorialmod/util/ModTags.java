...
//* this is for creating modtags for magic block to turn coal/compass/sticks to diamond *//
//* see util.ModTags and data.tutorialmod.tags.item.transformable items*//
