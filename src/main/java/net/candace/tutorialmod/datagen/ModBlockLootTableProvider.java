...
public class ModBlockLootTableProvider extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        this.add(ModBlocks.END_STONE_ALEXANDRITE_ORE.get(),
                block -> createMultipleOreDrops(ModBlocks.END_STONE_ALEXANDRITE_ORE.get(), ModItems.RAW_ALEXANDRITE.get(), 2, 6));
        ...
        this.add(ModBlocks.ALEXANDRITE_DOOR.get(), //* since 2 blocks high, will drop 2
